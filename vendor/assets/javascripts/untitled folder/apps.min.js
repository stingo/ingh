...
*/ var handleSlimScroll = function() {
  ...
  generateSlimScroll = function(a) {
    if (!$(a).attr("data-init")) {
      ...
      /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(
        ...
        : $(a).slimScroll(c), $(a).attr("data-init", !0);
    }
  },
  ...
  handleMobileSidebarToggle = function() {
    ...
    $(".sidebar").bind("click touchstart", function(b) {
      ...
      0 === $(b.target).closest(".sidebar").length &&
        (a = !1), b.isPropagationStopped() || a === !0 || ($("#page-container").hasClass("page-sidebar-toggled") && ((a = !0), $("#page-container").removeClass("page-sidebar-toggled")), $(window).width() <= 767 && $("#page-container").hasClass("page-right-sidebar-toggled") && ((a = !0), $("#page-container").removeClass("page-right-sidebar-toggled")));
      ...
      (d = $(window).width() < 979
        ...
        : d), $(c).hasClass(d) ? $(c).removeClass(d) : a !== !0 ? $(c).addClass(d) : (a = !1), $(window).width() < 480 && $("#page-container").removeClass("page-sidebar-toggled"), $(window).trigger("resize");
    ...
    return (
      ...
      ((panelActionRunning = !0), $(
        ...
        if (!$(b).hasClass("panel-loading")) {
          ...
          $(b).addClass("panel-loading"), $(c).prepend(
            d
          ), setTimeout(function() {
            $(b).removeClass(
              "panel-loading"
            ), $(b).find(".panel-loader").remove();
          }, 2e3);
        }
      ...
      }), void $(document).on("click", "[data-click=panel-expand]", function(
        a
      ) {
        a.preventDefault();
        ...
        if ($("body").hasClass("panel-expand") && $(b).hasClass("panel-expand"))
          $("body, .panel").removeClass("panel-expand"), $(".panel").removeAttr(
            "style"
          ), $(c).removeAttr("style");
        else if (
          ($("body").addClass("panel-expand"), $(this)
            .closest(".panel")
            .addClass("panel-expand"), 0 !== $(c).length && 40 != d)
        ) {
          var g = 40;
  ...
  handleThemePageStructureControl = function() {
    ...
    $.cookie &&
      ...
      ($(".sidebar").addClass("sidebar-grid"), $(
        '[name=sidebar-styling] option[value="2"]'
      ).prop("selected", !0)), $.cookie &&
      $.cookie("header-styling") &&
      0 !== $(".header").length &&
      "navbar-inverse" == $.cookie("header-styling") &&
      ($(".header").addClass("navbar-inverse"), $(
        '[name=header-styling] option[value="2"]'
      ).prop("selected", !0)), $.cookie &&
      $.cookie("content-gradient") &&
      0 !== $("#page-container").length &&
      "enabled" == $.cookie("content-gradient") &&
      ($("#page-container").addClass("gradient-enabled"), $(
        '[name=content-gradient] option[value="2"]'
      ).prop("selected", !0)), $.cookie &&
      $.cookie("content-styling") &&
      0 !== $("body").length &&
      "black" == $.cookie("content-styling") &&
      ($("body").addClass("flat-black"), $(
        '[name=content-styling] option[value="2"]'
      ).prop("selected", !0)), $(".theme-list [data-theme]").click(function() {
      var a = "assets/css/theme/" + $(this).attr("data-theme") + ".css";
      $("#theme").attr(
        "href",
        a
      ), $(".theme-list [data-theme]").not(this).closest("li").removeClass("active"), $(this).closest("li").addClass("active"), $.cookie("theme", $(this).attr("data-theme"));
      ...
      2 == $(this).val()
        ? ($("#sidebar").addClass("sidebar-grid"), $.cookie(
            "sidebar-styling",
            "grid"
          ))
        : ($("#sidebar").removeClass("sidebar-grid"), $.cookie(
            "sidebar-styling",
            "default"
          ));
    }), $(".theme-panel [name=content-gradient]").on("change", function() {
      2 == $(this).val()
        ? ($("#page-container").addClass("gradient-enabled"), $.cookie(
            "content-gradient",
            "enabled"
          ))
        : ($("#page-container").removeClass("gradient-enabled"), $.cookie(
            "content-gradient",
            "disabled"
          ));
    }), $(
      document
    ).on("change", ".theme-panel [name=content-styling]", function() {
      2 == $(this).val()
        ? ($("body").addClass("flat-black"), $.cookie(
            "content-styling",
            "black"
          ))
        : ($("body").removeClass("flat-black"), $.cookie(
            "content-styling",
            "default"
          ));
    }), $(
      document
    ).on("change", ".theme-panel [name=sidebar-fixed]", function() {
      1 == $(this).val()
        ? (2 == $(".theme-panel [name=header-fixed]").val() &&
            (alert(
              ...
              "#page-container"
            ).addClass("page-header-fixed")), $("#page-container").addClass(
            "page-sidebar-fixed"
          ), $("#page-container").hasClass("page-sidebar-minified") ||
            generateSlimScroll($('.sidebar [data-scrollbar="true"]')))
        : ($("#page-container").removeClass("page-sidebar-fixed"), 0 !==
            $(".sidebar .slimScrollDiv").length &&
            ($(window).width() <= 979
              ? $(".sidebar").each(function() {
                  if (
                    ...
                    $(this).find(".slimScrollBar").remove(), $(this)
                      .find(".slimScrollRail")
                      .remove(), $(this)
      ...
      document
    ).on("change", ".theme-panel [name=header-fixed]", function() {
      1 == $(this).val()
        ? ($("#header").addClass("navbar-fixed-top"), $(
            "#page-container"
          ).addClass("page-header-fixed"), $.cookie("header-fixed", !0))
        : (1 == $(".theme-panel [name=sidebar-fixed]").val() &&
            (alert(
              ...
              $("#page-container .sidebar-bg").length &&
              $("#page-container").append('<div class="sidebar-bg"></div>')), $(
            "#header"
          ).removeClass("navbar-fixed-top"), $("#page-container").removeClass(
            "page-header-fixed"
  ...
  handleSavePanelPosition = function(a) {
    ...
    if (0 !== $(".ui-sortable").length) {
      ...
      $.when(
        ...
        (c = c.split(
          "?"
        )), (c = c[0]), localStorage.setItem(c, JSON.stringify(b)), $(a).find('[data-id="title-spinner"]').delay(500).fadeOut(500, function() {
          $(this).remove();
        });
      });
    }
  ...
  handleResetLocalStorage = function() {
    ...
    $(document).on("click", "[data-click=reset-local-storage]", function(a) {
      ...
      document
    ).on("click", "[data-click=confirm-reset-local-storage]", function(a) {
      a.preventDefault();
      var b = window.location.href;
      (b = b.split(
        "?"
      )), (b = b[0]), localStorage.removeItem(b), location.reload();
    });
  },
  ...
  handleUnlimitedTabsRender = function() {
    function a(a, b) {
      var d = (parseInt($(a).css("margin-left")), $(a).width()),
        ...
        g = 0;
      if (
        ($(a).find("li.active").prevAll().each(function() {
          e += $(this).width();
      ...
      e != g && g >= d
        ...
        : $(a).removeClass("overflow-right"), e >= d && g >= d
  ...
  handleMobileSidebar = function() {
    ...
    $(
      ...
      if (
        (b.preventDefault(), /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(
          navigator.userAgent
        ))
      ) {
        var c = b.originalEvent.touches[0] || b.originalEvent.changedTouches[0],
  ...
  handleUnlimitedTopMenuRender = function() {
    ...
    function b() {
      ...
      g != i && i >= f
        ...
        : $(a)
            .find(".menu-control.menu-control-right")
            .removeClass("show"), g >= f && i >= f
        ? $(a).find(".menu-control.menu-control-left").addClass("show")
        : $(a).find(".menu-control.menu-control-left").removeClass("show");
    }
